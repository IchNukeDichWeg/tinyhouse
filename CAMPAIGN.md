...
| THB-02 | `from_tfen` accepts a promoted king | PENDING |
...
| ID | Item | Status |
|---|---|---|
| TH-01 | "no search extensions, so the ply budget is exact" is false | PENDING |
...
| TH-30 | test the Zobrist reseed contract | PENDING |
